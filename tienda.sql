...
SELECT p.nombre AS producte, precio AS preu, f.nombre AS fabricant FROM producto p JOIN fabricante fº  ON (f.codigo = p.codigo_fabricante);
SELECT p.nombre AS producte, precio AS preu, f.nombre AS fabricant FROM producto p JOIN fabricante f ON (f.codigo = p.codigo_fabricante) ORDER BY fabricant;
